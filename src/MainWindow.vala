/*-
 * Copyright 2018-2022 elementary, Inc. (https://phyre-os.io)
...
public class PantheonCalculator.MainWindow : Gtk.ApplicationWindow {
    ...
    construct {
        ...
        button_add.add_css_class (Granite.STYLE_CLASS_H2_LABEL);
        ...
        var button_div = new Button (" ÷ ") {
         ...
         button_div.add_css_class (Granite.STYLE_CLASS_H2_LABEL);
        button_div.add_css_class (Granite.STYLE_CLASS_SUGGESTED_ACTION);
